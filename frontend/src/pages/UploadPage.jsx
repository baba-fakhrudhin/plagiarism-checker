...
export default function UploadPage() {
  ...
  const handleStartAnalysis = async () => {
    ...
    try {
      ...
      alert('Error starting analysis: ' + error.response?.data?.error);
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
      <h1 className="text-4xl font-bold text-gray-800 mb-8">Upload & Analyze</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        {document && (
          <div className="bg-white rounded-lg shadow p-6 h-fit sticky top-20">
            <h2 className="text-xl font-bold mb-4 text-gray-800">Document Ready</h2>
            <div className="space-y-3 mb-6">
              ...
              <div>
                ...
                <p className="font-semibold text-gray-800">{document.file_type.toUpperCase()}</p>
              </div>
              <div>
